...
import { ConfirmacaoForm } from "./form";
...
export default async function ConfirmacaoPage({
  ...
  const { data: campaign } = await supabase
    .from("campaigns")
    .select("id, name, template_id, contact_list_id, profile_customization, scheduled_at")
    .eq("id", id)
    .single();
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <WizardBackLink href={`/campanhas/${campaign.id}/agendamento`} />
